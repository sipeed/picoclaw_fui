  ...
  static ThemeData getTheme(AppThemeMode mode) {
    switch (mode) {
      ...
      case AppThemeMode.sakura:
        return _buildTheme(
          primary: const Color(0xFFAD1457),      // Pink 800 (Sidebar - High contrast vs White text)
          primaryContainer: const Color(0xFFFDF2F8), // Rose 50 (Main Content - Low glare, high clarity)
          secondary: const Color(0xFFC2185B),    // Pink 700 (Primary Action/Highlight)
          isDark: false,
        );
    }
  }
  ...
  static ThemeData _buildTheme({
    ...
    return factory(
      ...
      subThemesData: FlexSubThemesData(
        ...
        navigationRailIndicatorSchemeColor: SchemeColor.onPrimary, // Indicator contrasts with Sidebar
        navigationRailIndicatorOpacity: 1.0,
        navigationRailBackgroundSchemeColor: SchemeColor.primary, // Force Rail to use our Primary color
